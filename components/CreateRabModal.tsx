...
import { X, ClipboardList, User, FileText, CircleDollarSign, Calendar, Save } from 'lucide-react';
...
const CreateRabModal = ({ isOpen, onClose, onSave, initialData }: CreateRabModalProps) => {
                ...
                <div className="flex items-start justify-between p-6 border-b border-border rounded-t-xl">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Isi detail Rencana Anggaran Biaya di bawah ini.</p>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                             <div>
                                ...
                                <div className={inputWrapperClasses}>
                                    ...
                                    <input type="number" name="tenderValue" id="tenderValue" value={formData.tenderValue || ''} onChange={handleChange} className={inputFieldClasses} min="0"/>
                                </div>
                            </div>
                            <div>
